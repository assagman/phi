# @mariozechner/phi-web-ui

Reusable web UI components for building AI chat interfaces powered by [@mariozechner/phi-ai](../ai) and [@mariozechner/phi-agent-core](../agent).
...
```bash
npm install @mariozechner/phi-web-ui @mariozechner/phi-agent-core @mariozechner/phi-ai
```
...
```typescript
import { Agent } from '@mariozechner/phi-agent-core';
...
import {
  ...
  defaultConvertToLlm,
  ApiKeyPromptDialog,
} from '@mariozechner/phi-web-ui';
import '@mariozechner/phi-web-ui/app.css';
...
declare module '@mariozechner/phi-agent-core' {
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@mariozechner/phi-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@mariozechner/phi-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@mariozechner/phi-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@mariozechner/phi-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@mariozechner/phi-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@mariozechner/phi-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@mariozechner/phi-web-ui';
...
```typescript
import { SessionListDialog } from '@mariozechner/phi-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@mariozechner/phi-web-ui';
...
```typescript
import { ModelSelector } from '@mariozechner/phi-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@mariozechner/phi-web-ui';
