...
```typescript
import { createAgentSession, discoverAuthStorage, discoverModels, SessionManager } from "coding-agent";
...
The `Agent` class (from `agent`) handles the core LLM interaction. Access it via `session.agent`.
...
import { discoverAuthStorage, discoverModels } from "coding-agent";
...
import { createAgentSession, type ToolDefinition } from "coding-agent";
...
```typescript
import { createAgentSession, type ExtensionFactory } from "coding-agent";
...
```typescript
import { createAgentSession, createEventBus } from "coding-agent";
...
```typescript
import { createAgentSession, discoverSkills, type Skill } from "coding-agent";
...
```typescript
import { createAgentSession, discoverContextFiles } from "coding-agent";
...
```typescript
import { createAgentSession, discoverPromptTemplates, type PromptTemplate } from "coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "coding-agent";
...
```typescript
import { createAgentSession, InteractiveMode } from "coding-agent";
...
```typescript
import { createAgentSession, runPrintMode } from "coding-agent";
...
```typescript
import { createAgentSession, runRpcMode } from "coding-agent";
