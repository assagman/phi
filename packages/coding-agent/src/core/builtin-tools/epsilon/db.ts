 ...
 *
 * Storage: ~/.local/share/phi/<repo-id>/epsilon.db
 * Tables:  tasks, schema_version
 */

import type { Database } from "bun:sqlite";
import { ensureSchemaVersion, escapeLike, getBuiltinDbPath, openDatabase } from "../storage.js";
...
export function getDb(): Database {
	const dbPath = getBuiltinDbPath("epsilon");
...
export function getDbLocation(): string {
	return getBuiltinDbPath("epsilon");
}
