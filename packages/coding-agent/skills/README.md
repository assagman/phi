...
# Task management
phi_epsilon add "task title" --priority 3
...
**No enum strings** - Numeric codes only:
...
phi_epsilon:
  --status N        1=todo  2=wip  3=blocked  4=done  5=drop
  --priority N      1=low  2=medium  3=high  4=critical
```

**Shorthand commands** - Common operations are single words:
- `phi_epsilon wip 1` instead of `phi_epsilon update 1 --status 2`
