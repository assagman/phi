/**
 * Delta v4 — Pure persistent memory extension for Phi coding agent.
 *
 * Provides: Unified memory with tags, importance, FTS5 full-text search.
 * Storage:  repo-scoped SQLite at ~/.local/share/phi-ext-delta/<repo-id>/delta.db
 *
...
export default function deltaExtension(pi: ExtensionAPI) {
	registerTools(pi);
