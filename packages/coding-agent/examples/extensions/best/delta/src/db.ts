 ...
 *
 * Storage: ~/.local/share/phi-ext-delta/<repo-id>/delta.db
...
function getDbPath(): string {
	return getExtensionDbPath("phi-ext-delta", "delta");
}
...
function stampSchemaVersion(db: Database, version: number): void {
