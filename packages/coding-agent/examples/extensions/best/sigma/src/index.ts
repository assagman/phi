 ...
 *   6. Long question text properly word-wrapped
 *   7. "Type something" option is ALWAYS present
 *
...
import { Text, truncateToWidth } from "tui";
...
export default function sigma(pi: ExtensionAPI) {
